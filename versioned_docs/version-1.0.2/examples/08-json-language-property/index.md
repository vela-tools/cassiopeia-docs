---
title: "Mapping multilingual JSON with a LanguageProperty"
sidebar_label: "LanguageProperty"
sidebar_position: 8
description: "Build a LanguageProperty and read a hyphenated source key."
keywords: ["NGSI-LD", "worked example", "json to NGSI-LD", "Region"]
---
...
The full mapping is in [region.json5](https://github.com/vela-tools/cassiopeia-examples/blob/main/examples/08-json-language-property/region.json5):
