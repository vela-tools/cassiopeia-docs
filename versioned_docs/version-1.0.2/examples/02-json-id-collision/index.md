---
title: "Keeping JSON entities with colliding IDs apart"
sidebar_label: "ID collisions"
sidebar_position: 2
description: "See how a weak city ID merges records, then add a geohash from the coordinates."
keywords: ["NGSI-LD", "worked example", "json to NGSI-LD", "City"]
---
...
The full mapping is in [city.json5](https://github.com/vela-tools/cassiopeia-examples/blob/main/examples/02-json-id-collision/city.json5):
...
The command uses `--context none` so the example does not need a JSON-LD context or a Smart Data Models catalog. [Output](../../guides/output.md#deliver-context) explains how to attach a real context later.
