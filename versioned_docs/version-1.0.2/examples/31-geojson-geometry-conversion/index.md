---
title: "Converting GeoJSON geometry types for a GeoProperty"
sidebar_label: "Geometry conversion"
sidebar_position: 31
description: "Demote an administrative region's MultiPolygon to the largest Polygon and derive a map-pin centroid beside it."
keywords: ["NGSI-LD", "worked example", "geojson to NGSI-LD", "Region"]
---
...
It uses a **custom** data model. See the [data-model guide](../../guides/data-models.md) for background.
...
The complete mapping is in [region.json5](https://github.com/vela-tools/cassiopeia-examples/blob/main/examples/31-geojson-geometry-conversion/region.json5):
