---
title: "Mapping JSON `datasetId` instances"
sidebar_label: "JSON datasetId"
sidebar_position: 21
description: "Keep forecasts from several models under one attribute."
keywords: ["NGSI-LD", "worked example", "json to NGSI-LD", "WeatherForecast"]
---
