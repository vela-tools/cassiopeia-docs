---
title: "Mapping KML folder collections in one run"
sidebar_label: "KML collections"
sidebar_position: 17
description: "Route four KML folders to four mappings."
keywords: ["NGSI-LD", "worked example", "kml to NGSI-LD", "CitiBikeStation", "BikeRentalShop", "Sightseeing", "PublicRestroom"]
---
...
The [previous example](../16-kmz-folder-namespacing/index.md) had one folder, so every record shared one namespace and one mapping. Here the manifest binds several folders by name.
